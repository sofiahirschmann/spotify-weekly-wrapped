...
export async function getDemoStats() {
  ...
  const suggestions = [
    ...
    suggestion("Petrichor", "Neon Grove", "deepcut", "Because you can't stop playing Neon Grove"),
    suggestion("Night Bus Home", "Marble Arcade", "rediscovery", "Your soundtrack a few months back"),
    suggestion("Low Tide", "Cassette Fauna", "deepcut", "Because you can't stop playing Cassette Fauna"),
